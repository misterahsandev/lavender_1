...
class Latest_productsPage extends StatelessWidget {
  final logic = Get.put(Latest_productsLogic());
  final state = Get
      .find<Latest_productsLogic>()
      .state;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<Latest_productsLogic>(builder: (latest_productlogic)
      => Scaffold(
